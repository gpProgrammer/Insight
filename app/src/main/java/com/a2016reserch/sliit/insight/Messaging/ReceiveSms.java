...
public class ReceiveSms extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void goToCompose(View view) {
        Intent intent = new Intent(ReceiveSms.this, SendSmsPhone.class);
        startActivity(intent);
    }
/*
    public void goToCompose(View view) {
        Intent intent = new Intent(ReceiveSms.this, SendSms.class);
        startActivity(intent);
    }
